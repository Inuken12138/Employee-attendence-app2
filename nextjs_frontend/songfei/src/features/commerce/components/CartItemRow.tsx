...
/**
 * Presentational row for one item in the active cart.
 *
 * It shows product identity, line totals, quantity controls, and the special UI
 * rules that apply to kitchen bundles generated by the planner.
 */
...
/** Renders one cart line and delegates quantity/removal actions back to the parent screen. */
