---
name: E-commerce storefront and category navigation
overview: Add an IKEA-style e-commerce storefront with hierarchical category navigation (landing page, big catalogue, category pages with sliders and breadcrumbs), a store-only header with ERP button and search, backend category model and APIs, and ERP product entry with folder-like category picker. Delivered as a concrete action plan plus an AI-ready implementation prompt.
todos: []
isProject: false
---
